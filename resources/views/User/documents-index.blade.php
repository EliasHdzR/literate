                        ...
                        <div class="col">
                            <div class="card shadow-sm bg-white border-0 h-100">
                                <div class="card-body d-flex flex-column p-0">
                                    <img
                                        src="{{ asset('storage/'.$document->header_logo_url ?? 'img/default-logo.png') }}"
                                        alt="Logo del documento" class="rounded-top-3">
                                </div>
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <small class="fs-6 fw-medium text-truncate">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="svg-icon"
                                             style="width: 23px; height: 23px; vertical-align: middle; fill: currentColor; overflow: hidden;"
                                    ...
                                    <small class="fs-6 fw-medium text-truncate">
                                        <svg xmlns:dc="http://purl.org/dc/elements/1.1/"
                                             ...
                                             xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" width="18px"
                                             height="18px" viewBox="0 0 448 448" id="svg2" version="1.1"
                                             inkscape:version="0.91 r13725" sodipodi:docname="status-info-outline.svg"
                                             fill="#000000">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                               stroke-linejoin="round"></g>
                                            <g id="SVGRepo_iconCarrier"><title id="title3339">
                                                    status-info-outline</title>
                                                <defs id="defs4">
                                                    <pattern y="0" x="0" height="6" width="6"
                                                             patternUnits="userSpaceOnUse"
                                                             id="EMFhbasepattern"></pattern>
                                                </defs>
                                                <sodipodi:namedview id="base" pagecolor="#ffffff" bordercolor="#666666"
                                                                    borderopacity="1.0" inkscape:pageopacity="0.0"
                                                                    inkscape:pageshadow="2" inkscape:zoom="0.98994952"
                                                                    inkscape:cx="239.70135" inkscape:cy="220.8132"
                                                                    inkscape:document-units="px"
                                                                    inkscape:current-layer="layer1" showgrid="true"
                                                                    units="px" inkscape:snap-bbox="true"
                                                                    inkscape:bbox-nodes="true"
                                                                    inkscape:window-width="1173"
                                                                    inkscape:window-height="914" inkscape:window-x="279"
                                                                    inkscape:window-y="1047"
                                                                    inkscape:window-maximized="0">
                                                    <inkscape:grid type="xygrid" id="grid3336" spacingx="16"
                                                                   spacingy="16" empspacing="2"></inkscape:grid>
                                                </sodipodi:namedview>
                                                <metadata id="metadata7">
                                                    <rdf:rdf>
                                                        <cc:work rdf:about="">
                                                            ...
                                                            <dc:title>status-info-outline</dc:title>
                                                        </cc:work>
                                                    </rdf:rdf>
                                                </metadata>
                                                <g inkscape:label="Layer 1" inkscape:groupmode="layer" id="layer1"
                                                   transform="translate(0,-604.36209)">
                                                    <text sodipodi:linespacing="125%" id="text3347" y="628.57739"
                                                          x="-1063.7494"
                                                          style="font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;font-size:90px;line-height:125%;font-family:'Segoe UI';-inkscape-font-specification:'Segoe UI';text-align:start;letter-spacing:0px;word-spacing:0px;text-anchor:start;fill:#000000;fill-opacity:1;stroke:none"
                                                          xml:space="preserve"> <tspan id="tspan3349" y="0" x="0"
                                                                                       sodipodi:role="line">
                                                            <tspan id="tspan3351"
                                                                   style="font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;font-size:90px;font-family:'Segoe UI';-inkscape-font-specification:'Segoe UI';fill:#000000"
                                                                   dy="0" dx="0"></tspan>
                                                        </tspan> </text>
                                                    <path id="path3342" style="fill-opacity:1;stroke:none"
                                                          d="m 264,724.36206 a 40,40.000015 0 0 1 -40,40.00002 40,40.000015 0 0 1 -40,-40.00002 40,40.000015 0 0 1 40,-40.00001 40,40.000015 0 0 1 40,40.00001 z m -72,72 64,0 0,160.00003 -64,0 z m 32,-191.99997 a 224,224 0 0 0 -224,224 224,224 0 0 0 224,224.00001 224,224 0 0 0 224,-224.00001 224,224 0 0 0 -224,-224 z m 0,32 a 192,192 0 0 1 192,192 192,192 0 0 1 -192,192.00001 192,192 0 0 1 -192,-192.00001 192,192 0 0 1 192,-192 z"></path>
                                                </g>
                                            </g>
                                        </svg>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu"
                                                    ...
                                                    @if($document->status != 'Firmado')
                                                        <li>
                                                            <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                               data-bs-target="#firmar-documento-{{ $document->id }}">
                                                                <svg width="32px" height="32px" viewBox="0 0 30 30"
                                                    ...
                                                    @if($document->status == 'Firmado')
                                                        <li>
                                                            <a class="p-2"
                                                               href="{{ route('documents.export', ['id' => $document->id]) }}">
                                                                <svg width="21" height="21" viewBox="0 0 7 7"
                                                                    ...
                                                                    <defs>
                                                                        <clipPath id="clip0_201_23365">
                                                                            <rect width="6.6641" height="6.6641"
                                                                                  fill="white"
                                                                                  transform="translate(0.275513 0.649414)"/>
                                                                        </clipPath>
                                                                    </defs>
                                                                </svg>
                                                                Imprimir
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                           data-bs-target="#comentar-documento-{{ $document->id }}">
                                                            <svg width="23px" height="23px" viewBox="0 0 21 21"
                                                                 fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                                   stroke-linejoin="round"></g>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item text-danger" href="#"
                                                           ...
                                                           data-bs-target="#eliminar-{{ $document->id }}">
                                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                                 xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M16.6041 8.39014C16.6041 8.39014 16.1516 14.0026 15.8891 16.3668C15.7641 17.496 15.0666 18.1576 13.9241 18.1785C11.7499 18.2176 9.57326 18.2201 7.39993 18.1743C6.30076 18.1518 5.61493 17.4818 5.49243 16.3726C5.22826 13.9876 4.77826 8.39014 4.77826 8.39014"
                                                                    stroke="black" stroke-width="1.5"
                                                                    stroke-linecap="round" stroke-linejoin="round"/>
                                                                <path d="M17.7569 5.69963H3.62518" stroke="black"
                                                                      stroke-width="1.5" stroke-linecap="round"
                                                                      stroke-linejoin="round"/>
                                                                <path
                                                                    d="M15.0339 5.69974C14.3797 5.69974 13.8164 5.23724 13.688 4.5964L13.4855 3.58307C13.3605 3.11557 12.9372 2.79224 12.4547 2.79224H8.92719C8.44469 2.79224 8.02136 3.11557 7.89636 3.58307L7.69386 4.5964C7.56552 5.23724 7.00219 5.69974 6.34802 5.69974"
                                                                    stroke="black" stroke-width="1.5"
                                                                    stroke-linecap="round" stroke-linejoin="round"/>
                                                            </svg>
                                                            Cancelar Emisión
                                    ...
                                    <!-- Modal Firmar -->
                                    <div class="modal fade" id="firmar-documento-{{ $document->id }}"
                                         data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                         aria-labelledby="firmarDocumentoLabel-{{ $document->id }}" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="sign-form-{{ $document->id }}"
                                                          action="{{route('documents.sign', $document->id)}}"
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" form="sign-form-{{ $document->id }}"
                                                            class="btn btn-primary">Firmar
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- modal comentar -->
                                    <div class="modal fade max-h-[60vh]" id="comentar-documento-{{ $document->id }}"
                                         data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                         aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Ver
                                                        Comentarios</h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                </div>
                                                        ...
                                                        <div class="card mb-2">
                                                            <div class="card-header">
                                                                <strong>{{ $comment->user->name }}
                                                                    - {{ date('D, d M Y H:i:s', strtotime($comment->created_at)) }}</strong>
                                                            </div>
                                                            <div class="card-body">
                                    ...
                                    <div class="modal fade" id="eliminar-{{ $document->id }}" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p><strong>Fecha de creación:</strong> {{ $document->created_at }}
                                                    </p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                    ...
                                                    <form action="{{ route('user.documents.cancel', $document->id) }}"
                                                          method="POST">
                                                        @csrf
                                                        @method('PATCH')
