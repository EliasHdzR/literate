                        ...
                        <div class="col">
                            <div class="card shadow-sm bg-white border-0 h-100">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <small class="fs-6 fw-medium text-truncate">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="svg-icon" style="width: 23px; height: 23px; vertical-align: middle; fill: currentColor; overflow: hidden;" viewBox="0 0 1024 1024">
