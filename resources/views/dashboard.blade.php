                        ...
                        <div class="col">
                            <div class="card shadow-sm bg-white border-0 h-100">
                                <div class="card-body d-flex flex-column p-0">
                                    <img src="{{ asset('storage/'.$document->header_logo_url ?? 'img/default-logo.png') }}" alt="" class="rounded-top-3">
                                </div>
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex justify-content-end mt-2">
                                        <a class="p-2" href="{{ route('documents.edit', $document) }}">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="card-body d-flex flex-column p-0">
                                                            <img src="{{ asset('storage/'.$document->header_logo_url ?? 'img/default-logo.png') }}" alt="" class="rounded-3">
                                                        </div>
                                                        <p class="mt-4"> Nombre: <strong> {{ $document->name }} </strong></p>
                                                        <p class="m-0"> Fecha de creación: <strong> {{ $document->created_at }} </strong></p>
                                                    </div>
