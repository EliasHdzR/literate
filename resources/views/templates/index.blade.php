    ...
    <div class="row align-items-center mb-4">
        ...
        <div class="col-2">
            <div class="d-flex align-items-center">
                <button type="button" onclick="window.location.href='{{ route('templates.create') }}'" class="btn btn-primary text-nowrap p-2 px-4 fw-medium w-100 shadow-sm">
                    ...
                    <div class="col">
                        <div class="card shadow-sm bg-white border-0 h-100">
                            <div class="card-body d-flex flex-column p-0">
                                <img src="{{ asset('storage/'.$template->header_logo_url) }}" alt="" class="rounded-top-3">
                            </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="card-body d-flex flex-column p-0">
                                                            <img src="{{ asset('storage/'.$template->header_logo_url) }}"  alt="" class="rounded-3">
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ route('templates.destroy', $template) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                                <button type="submit" class="btn btn-primary">Eliminar plantilla</button>
                                                        </form>
                                                    </div>
                                            </div>
                                        </div>
