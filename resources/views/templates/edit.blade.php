...
<div class="col px-5">
    <div class="text-center">
        <small class="text-muted fs-6">Editar Plantilla</small>
    ...
    <div class="d-flex justify-content-center">
        <div class="row w-75 p-4">
            <div class="col-md-8 mx-auto">
                <!-- formulario -->
                <form method="POST" action="{{ route('templates.update', ['template' => $template]) }}" class="shadow-sm bg-white p-4 rounded" enctype="multipart/form-data"    >
                    @csrf
                    @method('PATCH')
                    <!-- nombre almacen -->
                    <div class="mb-3">
                        <label for="name" class="form-label">Nombre de la plantilla</label>
                        <input type="text" class="form-control bg-white" id="name" name="name" value="{{ $template->name }}" required>
                    </div>
                    <!-- lugar -->
                    <div class="mb-3">
